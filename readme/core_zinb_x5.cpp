...
Rcpp::List zinb_model_estimator(IntegerMatrix Y, IntegerVector z, NumericVector s, int iter, 
                                bool DPP, IntegerMatrix S, bool aggregate, bool store, 
                                bool MRF, IntegerMatrix G, double b = 1, double h = 100, 
                                double f_val = 2, double d_val = -2.2, double phi_low = 1, int count_minimum = 3) {
